...
func _ready():
	...
	match text_type:
		TextType.DAMAGE:
			label.set("theme_override_colors/font_color", Color("fa4646"))
		TextType.HEALING:
			label.set("theme_override_colors/font_color", Color("6ef87d"))
		TextType.AP:
			label.set("theme_override_colors/font_color", Color("7e51ed"))
		TextType.MP:
			label.set("theme_override_colors/font_color", Color("51ed8b"))
	...
	tween.connect("tween_all_completed", Callable(self, "on_tween_completed"))
